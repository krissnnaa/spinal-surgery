...
from imblearn.under_sampling import Rand"""
Created on Wed Aug 10 11:21:02 2019
@author: krishna
"""
from __future__ import absolute_import, division, print_function
...
def deepLearningClassification(x_train, y_train, x_test, y_test):
    ...
    y_pre=list(y_pre)
    y_test=list(y_test)
    p, r, f, s = precision_recall_fscore_support(y_test, y_pre, pos_label=1, average='binary')
    print('Precision of Decision tree = %f' % p)
    print('Recall of Decision tree = %f' % r)
    print('F1 score of Decision tree = %f' % f)
    confusion_matrix_plot(y_test, y_pre)
...
if __name__ == '__main__':
    ...
    multiLableClassification(X_train,yTrain,X_test,yTest)omUnderSampler
from sklearn.datasets import make_multilabel_classification
from sklearn.metrics import roc_auc_score
from sklearn.multiclass import OneVsRestClassifier
from sklearn.metrics import make_scorer
